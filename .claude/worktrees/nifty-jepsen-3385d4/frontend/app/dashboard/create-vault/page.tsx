...
import { Clock, Shield, CheckCircle2, Loader2, Sparkles } from 'lucide-react';
          ...
          <div className="card mb-8">
            ...
            <div className="space-y-4">
              <label className="flex items-start p-6 border-2 border-primary/30 rounded-lg hover:bg-primary/5 cursor-pointer transition-all">
                ...
                />
                <div className="ml-4">
                  <div className="text-lg font-bold text-primary flex items-center gap-2"><Clock className="w-5 h-5" /> FIXED Vault</div>
              ...
              <label className="flex items-start p-6 border-2 border-accent/30 rounded-lg hover:bg-accent/5 cursor-pointer transition-all">
                ...
                />
                <div className="ml-4">
                  <div className="text-lg font-bold text-accent flex items-center gap-2"><Shield className="w-5 h-5" /> FLEXIBLE Vault</div>
                  <div className="text-light/70 mt-2">
              ...
              <div className="flex justify-between items-center py-3 border-b border-primary/10">
                ...
                <div className="font-semibold flex items-center gap-1.5">
                  {formData.vaultType === 'FIXED'
                    ? <><Clock className="w-4 h-4 inline" /> FIXED</>
                    : <><Shield className="w-4 h-4 inline" /> FLEXIBLE</>}
                </div>
              </div>
        ...
        {currentStep === 5 && (
          <div className="card mb-8">
            ...
            <div className="bg-primary/10 border border-primary/30 rounded-lg p-4 mb-6">
              <div className="text-primary font-semibold flex items-center gap-2"><CheckCircle2 className="w-4 h-4" /> Ready to create vault</div>
          ...
          {currentStep < 5 ? (
            ...
            >
              {mutation.isPending
                ...
                : <span className="flex items-center gap-2"><Sparkles className="w-4 h-4" /> Create Vault</span>}
            </button>
          )}
        </div>
      </form>
