...
import { Lock, Clock, Shield, Network, BarChart3, Plus, CheckCircle2 } from 'lucide-react';
          ...
          <div className="max-w-4xl mx-auto text-center">
            <div className="mb-8">
              <span className="inline-block px-4 py-2 bg-primary/10 border border-primary/20 rounded-full text-primary text-sm font-medium">
                <Lock className="w-3.5 h-3.5 inline mr-1.5 -mt-0.5" />Testnet Release
              </span>
            </div>
        ...
        <section id="features" className="px-4 py-20">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {/* Feature 1 */}
              <div className="card">
                <div className="text-primary mb-4"><Lock className="w-10 h-10" /></div>
              ...
              {/* Feature 2 */}
              <div className="card">
                <div className="text-primary mb-4"><Clock className="w-10 h-10" /></div>
              ...
              {/* Feature 3 */}
              <div className="card">
                <div className="text-primary mb-4"><Shield className="w-10 h-10" /></div>
              ...
              {/* Feature 4 */}
              <div className="card">
                <div className="text-primary mb-4"><Network className="w-10 h-10" /></div>
              ...
              {/* Feature 5 */}
              <div className="card">
                <div className="text-primary mb-4"><BarChart3 className="w-10 h-10" /></div>
              ...
              {/* Feature 6 */}
              <div className="card">
                <div className="text-primary mb-4"><Plus className="w-10 h-10" /></div>
        ...
        <section className="px-4 py-20">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-8 text-center">
              <div>
                <div className="text-primary mb-3 flex justify-center"><CheckCircle2 className="w-9 h-9" /></div>
